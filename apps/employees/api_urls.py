...
from apps.employees.apis.open_bookings import accept_booking, fetch_booking_services, list_open_bookings

from apps.employees.apis.file_upload import fetch_done_bookings_with_pending_file_upload, fetch_files_from_service
from apps.employees.apis.file_upload import presigned_url_for_file_upload, acknodwledge_file_upload
...
urlpatterns = [
    ...
    path(r'openbookings/fetch/services/<uuid:booking_id>/', fetch_booking_services.index , name="URL to fetch a booking using booking id"),
